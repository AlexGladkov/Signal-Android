...
import solonsky.signal.twitter.activities.AdvancedActivity;
import solonsky.signal.twitter.activities.LoggedActivity;
import solonsky.signal.twitter.activities.MVPSearchActivity;
import solonsky.signal.twitter.activities.SettingsActivity;
...
public interface AppComponent {
    ...
    void inject(AdvancedActivity activity);
