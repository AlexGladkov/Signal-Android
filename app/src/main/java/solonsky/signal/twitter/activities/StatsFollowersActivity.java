...
public class StatsFollowersActivity extends AppCompatActivity {

    private static final String TAG = StatsFollowersActivity.class.getSimpleName();
    private User user;
    ...
    private StatsFollowersActivity mActivity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTxtSubtitle.setText(getString(R.string.stats_followers) + ": " + Utilities.parseFollowers(user.getFollowersCount(), ""));
        ...
        mAdapter = new UserAdapter(userModels, getApplicationContext(), this, new UserAdapter.UserClickHandler() {
            ...
            public void onItemClick(UserModel model, View v) {
                if (model.getUser() != null) {
                    ...
                    StatsFollowersActivity.this.startActivity(profileIntent);
                    StatsFollowersActivity.this.overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                }
            }
        });
...
//                            Toast.makeText(getApplicationContext(), "Error loading " + te.getErrorMessage(), Toast.LENGTH_SHORT).show();
        ...
        if (currentIds == null || loadedSize >= currentIds.length) {
            asyncTwitter.getFollowersIDs(user.getScreenName(), nextCursor);
        } else {
