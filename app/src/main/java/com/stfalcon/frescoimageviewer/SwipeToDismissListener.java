...
class SwipeToDismissListener implements View.OnTouchListener {
    ...
    private final String TAG = SwipeToDismissListener.class.getSimpleName();
    ...
    public SwipeToDismissListener(ImageViewer imageViewer, View swipeView, OnDismissListener dismissListener,
    ...
    public boolean onTouch(View v, MotionEvent event) {
        translationLimit = v.getHeight() / 12;
    ...
    private void animateSwipeView(int parentHeight) {
        ...
        if (imageViewer != null && isDismissed) imageViewer.disableAnimation();
