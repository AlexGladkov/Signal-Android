...
import solonsky.signal.twitter.draw.ParallaxPageTransformer;
...
class ImageViewerView extends RelativeLayout
    ...
    public void setUrls(ImageViewer imageViewer, ImageViewer.DataSet<?> dataSet, int startPosition) {
        this.imageViewer = imageViewer;
        swipeDismissListener.setImageViewer(imageViewer);
    ...
    private void init() {
        ...
        pager.setPageTransformer(true, new ParallaxPageTransformer(R.id.container));

        dismissContainer = (ViewGroup) findViewById(R.id.container);
        swipeDismissListener = new SwipeToDismissListener(imageViewer, findViewById(R.id.dismissView), this, this);
    ...
    private void onClick(MotionEvent event, boolean isOverlayWasClicked) {
        if (overlayView != null && !isOverlayWasClicked) {
            if (imageViewer != null) imageViewer.changeStatusBar(overlayView.getVisibility() != View.VISIBLE);
