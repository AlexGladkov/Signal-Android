...
//        dialog.getWindow().setAttributes(winParams);
     ...
     * @param isShow - @true for show
     */
    void changeStatusBar(boolean isShow) {
        if (dialog.getWindow() != null) {
            if (isShow) {
    ...
    public static class Builder<T> {
        ...
        private @StyleRes int styleRes = R.style.statusMediaStyle;
        ...
        public Builder setStyleRes(int styleRes) {
