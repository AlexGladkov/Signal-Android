...
class ImageViewerAdapter
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.drawee_image, parent, false);
    ...
    class ImageViewHolder extends ViewHolder implements OnScaleChangeListener {
        ...
        private final String TAG = ImageViewHolder.class.getSimpleName();
        ...
        ImageViewHolder(View itemView) {
            super(itemView);
            drawee = (ZoomableDraweeView) itemView.findViewById(R.id.zdv_image);
        }
